...
COPY . .
#RUN make install-requirements && make VERIFY=true all && make install-binaries
RUN make install-requirements && make generate && make install && make install-binaries
