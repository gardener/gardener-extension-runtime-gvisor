...
import (
	...
	gardenerutils "github.com/gardener/gardener/pkg/utils/managedresources"
...
func (a *actuator) deleteManagedResource(ctx context.Context, namespace, managedResourceName, secretName string) error {
	...
	defer cancel()
	if err := gardenerutils.WaitUntilManagedResourceDeleted(timeoutCtx, a.client, namespace, managedResourceName); err != nil {
		return err
	}
	return nil
}
